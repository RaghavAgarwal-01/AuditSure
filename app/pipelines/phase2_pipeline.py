...
from app.models.business_profile import BusinessProfile, validate_against_ontology
...
def run_phase2(profile: BusinessProfile, onto: OntologyLoader | None = None) -> ProofObject:
    from app.engines.registration_engine import RegistrationEngine   # local import: avoids a module-load cycle

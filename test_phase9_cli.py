...
Run: pytest -v test_phase9_cli.py
"""
...
from profile_loader import ProfileLoadError, load_profile_from_dict, load_profile_from_json
...
def test_example_persona_runs_through_full_pipeline_without_error(example_file):
    from auditsure_pipeline import run_compliance_check
    from ontology_loader import get_default_loader
